...
def load_initiatives():
    try:
        with open('initiatives.json', 'r') as file:
            ...
            print("Loaded initiatives:", initiatives)
            return initiatives
...
def find_similar_initiatives(user_description, initiatives, max_results=5):
    try:
        ...
        for initiative in initiatives:
            ...
            #initiative_embedding = get_embedding(initiative_desc)
...
def search():
    ...
    similar_initiatives = find_similar_initiatives(user_description, initiatives)

    print("Similar initiatives:", similar_initiatives)  # Debug print
